...
<template>
    <div>
        ...
        <nav-crumbs><span>Counter</span></nav-crumbs>
        <div>
                    ...
                    <li v-for="item in cartList" :key="item.productId">
                      <div class="cart-tab-1">
                        ...
                        <div class="cart-item-pic">
                          <img v-lazy="'/static/img/'+item.productImg" v-bind:alt="item.productName">
                        </div>
                      ...
                      <div class="cart-tab-4">
                        <div class="item-price-total">{{(item.number*item.productPrice)|currency('$')}}</div>
                      </div>
